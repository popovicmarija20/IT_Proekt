...
namespace IT_proekt.Controllers
{
    public class OrderFormsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,CardNumber,Expiration,Cvc,CardOwner")] OrderForm orderForm)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,CardNumber,Expiration,Cvc,CardOwner")] OrderForm orderForm)
        {
            if (ModelState.IsValid)
            {
